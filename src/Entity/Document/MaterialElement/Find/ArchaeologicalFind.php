...
use App\Entity\Document\MaterialElement\Find\RelationToEstates\AbstractRelationToEstates;
use App\Entity\Document\MaterialElement\Find\RelationToSquares\AbstractRelationToSquares;
use App\Entity\Document\MaterialElement\Find\RelationToStrata\AbstractRelationToStrata;
...
class ArchaeologicalFind extends AbstractFind implements ExcavationDependentFindInterface
{
     ...
     * @var Excavation|null
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Document\MaterialElement\Find\Excavation", cascade={"persist"})
     ...
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Document\MaterialElement\Find\RelationToEstates\AbstractRelationToEstates", cascade={"persist"})
     ...
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Document\MaterialElement\Find\RelationToSquares\AbstractRelationToSquares", cascade={"persist"})
     ...
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Document\MaterialElement\Find\RelationToStrata\AbstractRelationToStrata", cascade={"persist"})
